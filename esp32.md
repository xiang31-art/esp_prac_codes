...
・サーミスタ 103JT-025
  -サーミスタの測定方法について理解
  -データシート参照
   https://www.murata.com/ja-jp/products/thermistor/ntc/overview/basic/characteristic
  -基準抵抗　抵抗値計算
  -INA219のアドレス変更(はんだ付け)
・プログラム
  -INA219コードコピー
...
09/22
・時計のチップ抵抗の抵抗値測定
-小さすぎる&接触抵抗と思われるものの変動が激しくて断念
-写真は片手(撮影上の都合)だが、測定時は両手でしっかり計測
-基盤と平行に近い状態になるようにも試したが、よくわからない。
チップ抵抗策断念
